...
class FlipTransform extends StaticTransform {
  ...
  Widget horizontal(double aniValue, int index, double page, Widget child) {
    return super.horizontal(
        aniValue, index, page, horizontalFlip(aniValue, index, page, child));
  }
  ...
  Widget vertical(double aniValue, int index, double page, Widget child) {
    return super.vertical(
        aniValue, index, page, verticalFlip(aniValue, index, page, child));
  }
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return Column(
        children: List.generate(shutterSize, (indexSub) {
          ...
          if (page > index) {
            intervalAni =
                Interval(indexSub * delay, 1 - (shutterSize - indexSub) * delay)
                    .transform(aniValue.abs());
            // return SizedBox.shrink();
          } else {
          ...
          return ClipRect(
            child: Align(
              ...
              child: SizedBox(
                  ...
                  child: super.horizontalFlip(intervalAni, index, page, child)),
            ),
          );
        }),
      );
        ...
        return ClipRect(
          child: Align(
            ...
            child: SizedBox(
                ...
                child: super.verticalFlip(intervalAni, index, page, child)),
          ),
        );
      }),
    );
